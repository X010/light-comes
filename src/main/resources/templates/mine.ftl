...
<head>
    ...
    <style>
        ...
        .mainlist img,.mainlist p{ float: left; font-size: 2.4rem;}
        .mainlist img{ width: 50px; height: 50px; margin:0 5%;}
        .mainlist a{float: right; font-size: 3.6rem; color: #ccc; margin-right:5rem; line-height: 50px;}
        .quit{ width: 40%; height: 5%; margin-top: 6%; margin-left: 30%;}
        .quit img{ width: 100%; height: 100%;}
    </style>
</head>
