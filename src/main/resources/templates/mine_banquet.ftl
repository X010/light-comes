    ...
    <div class="content">
        <div class="mui-order-cate">
            <div class="segmented-control" id="orderStatusList">
                <a class="control-item" id="order_status_0" href="mine_banquet.action">全部</a>
                <a class="control-item" id="order_status_1" href="mine_banquet.action?status=1">进行中</a>
                <a class="control-item" id="order_status_2" href="mine_banquet.action?status=2">已结束</a>
            </div>
        </div>
