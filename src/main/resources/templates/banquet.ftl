...
<head>
    ...
    <script id="post_list" type="text/html">
            ...
            <li class="msg" onclick="location.href='/banquet/banquet_d.action?aid={{d[i].id}}'">
                <div class="msg-left">
                    <img src="{{d[i].photo}}" />
                </div>
                <div class="msg-right">
...
<script type="text/javascript">
    var opts = {
            ...
            function loadMore(){
                ...
                $.ajax({
                    type:'GET',
                    url:'/banquet/banquet_list.action?page='+pages,
            ...
            function appendHtml(json){
                ...
                {
                    if(json[i].memo.length>26){
                        json[i].memo = json[i].memo.substring(0,26)+"...";
                    }
