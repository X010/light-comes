...
<head>
    ...
    <script id="post_list" type="text/html">
            ...
            <li class="msg" onclick="location.href='banquet_d.action?aid={{d[i].id}}'">
                <div class="msg-left">
                    <img src="{{d[i].photo}}" />
                </div>
                <div class="msg-right">
...
<footer>
    ...
    <a href="${baseUrl}banquet/banquet.action" class="on">
        <img class="" src="${baseUrl}images/date_on.png"/>
...
<script type="text/javascript">
    var opts = {
            ...
            function loadMore(){
                ...
                $.ajax({
                    type:'GET',
                    url:'banquet_list.action?page='+pages,
